...
export function usePeopleFichas(updateTrigger) {
  ...
  const [isLoading, setIsLoading] = useState(true); // Adicionando um estado para o carregamento
  useEffect(() => {
    setIsLoading(true);
    fetch(`${apiPath}/pessoas`, {
      ...
      .then((data) => {
        ...
        setIsLoading(false); // Finaliza o carregamento aqui
      })
      .catch((err) => console.log(err));
    setIsLoading(false); // Finaliza o carregamento
  }, [updateTrigger]);
  return [fichas, setFichas, isLoading];
}
